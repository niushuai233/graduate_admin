...
<form class="layui-form " action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <button class="layui-btn search-btn" table-id="sysOssTable" lay-submit="" lay-filter="search"><i
...
<div class="layui-btn-group">
    ...
    <@shiro.hasPermission name="sysoss:update">
        ...
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','sysOssTable','/sysoss/disable')">
