...
<div class="layui-form-item">
    ...
    <div class="layui-input-normal">
        <input type="text" name="bucket" maxlength="50" value="" lay-verify="required"
...
<div class="layui-form-item">
    ...
    <div cyType="radioTool" cyProps="codeName:'state'"
         name="state" value="${(model.state)!"0"}" class="layui-input-normal"></div>
</div>
