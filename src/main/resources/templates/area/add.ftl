    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-normal">
                <input type="text" name="areaName" lay-verify="required" placeholder="请输入地区名称" maxlength="50"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-normal">
                <input type="text" name="xzCode" lay-verify="number" placeholder="请输入地区行政编码" maxlength="8"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="page-footer">
            <div class="btn-list">
                <div class="btnlist">
                    <button class="layui-btn" lay-submit="" lay-filter="submit" data-url="/area/save"><i
