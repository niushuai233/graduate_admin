...
<div class="layui-btn-group">
        ...
        <button class="layui-btn" onclick="editPage('eduQuestionsCommentTable','/eduquestionscomment/edit')">
         ...
         <button class="layui-btn layui-btn-green" onclick="updateState('批量启用','eduQuestionsCommentTable','/eduquestionscomment/enable')">
            <i class="fa fa-check-square-o">&nbsp;</i>启用
        </button>
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','eduQuestionsCommentTable','/eduquestionscomment/disable')">
            <i class="fa fa-expeditedssl">&nbsp;</i>禁用
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="eduquestionscomment:delete">
         <button class="layui-btn layui-btn-delete" onclick="deleteBatch('批量删除','eduQuestionsCommentTable','/eduquestionscomment/delete');">
    ...
    <table class="layui-table" id="eduQuestionsCommentTable" cyType="pageGrid"
        ...
        <tr>
            ...
            <th width="10%" param="{name:'id',isPrimary:'true',hide:'true'}">主键id</th>
		          ...
		          <th width="10%" param="{name:'questionId'}">问答id</th>
			            			
		          <th width="10%" param="{name:'content'}">评论内容</th>
			            			
		          <th width="10%" param="{name:'isBest'}">是否最佳答案 0否1是</th>
			            			
		          <th width="10%" param="{name:'replyCount'}">回复数量</th>
			            			
		          <th width="10%" param="{name:'praiseCount'}">点赞数</th>
			            			
		          <th width="10%" param="{name:'addTime'}">回复时间</th>
