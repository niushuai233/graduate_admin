...
<form class="layui-form " action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="subjectNameVague" placeholder="请输入名称" class="layui-input">
        </div>
        <label class="layui-form-label">上级菜单:</label>
        <div class="layui-input-inline">
            <input value="" id="parent" cyType="treeTool" cyProps="url:'/syssubject/selectTreeTool',name:'parentId'"
