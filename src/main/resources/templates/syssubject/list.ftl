...
<div class="layui-btn-group">
        ...
        <button class="layui-btn  layui-btn-danger" onclick="updateState('批量禁用','sysSubjectTable','/syssubject/disable')">
            <i class="fa fa-expeditedssl">&nbsp;</i>禁用
        </button>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="syssubject:delete">
         <button class="layui-btn layui-btn-delete" onclick="deleteBatch('批量删除','sysSubjectTable','/syssubject/delete');">
    ...
    <table class="layui-table" id="sysSubjectTable" cyType="pageGrid"
        ...
        <tr>
            ...
            <th width="10%" param="{name:'subjectId',isPrimary:'true',hide:'true'}">主键</th>
		          ...
		          <th width="10%" param="{name:'parentId'}">父ID</th>
			            			
		          <th width="10%" param="{name:'sort'}">排序</th>
			            			
		          <th width="10%" param="{name:'status'}">状态 0:默认 1:删除</th>
