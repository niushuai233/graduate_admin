...
layui.define('layer', function(exports){
            ...
            select: function(){
                ...
                selects.each(function(index, select){
                    ...
                    if(typeof othis.attr('multiple') && typeof othis.attr('multiple') === 'string'){
                      /**2017/11/22 niushuai 获取select中的value  多个值用逗号隔开*/
    ...
    var submit = function(){
        ...
        layui.each(verifyElem, function(_, item){
            ...
            layui.each(ver, function(_, thisVer){
                ...
                if(verify[thisVer] && (isFn ? tips = verify[thisVer](value, item) : !verify[thisVer][0].test(value)) ){
                    /**如果是下拉框 将object转为美化后的dom  用于验证提示  2017/11/02 niushuai**/
                    if( othis.get(0).tagName=='SELECT'){
                        othis=othis.next();
                    }

                    /**修改错误提示框  2017/10/02 niushuai**/
        ...
        layui.each(fieldElem, function(_, item){
            ...
            /**解决复选框相同name只能获取最后一个值问题. by niushuai 2017/7/26*/
