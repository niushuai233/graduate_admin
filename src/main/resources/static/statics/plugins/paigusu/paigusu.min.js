    ...
    g.prototype = {
        init: function () {
            ...
            if (this.options.recommend) {
                ...
                var a = f.localStorage, b = a.getItem("paigusu-lately");
            ...
            d - e.bottom > a.height ? this.set({positionTop: e.top}) : this.set({positionTop: e.bottom - a.height})
        }, doploy: function () {
            var a = this.options;
            c("#paigusu-slider-btn").css("left", a.colorSlider - 5);
            var b = this.hsbToHex({h: a.colorSlider / 160 * 360, s: 100, b: 100}), d = this.hexToRgb(b),
                e = {h: a.colorSlider / 160 * 360, s: 100, s: a.hsb.s, b: a.hsb.b}, b = this.hsbToHex(e),
                f = this.hexToRgb(b);
            f.a = a.color.a;
            ...
            var a = this.options.hsb, b = this.hsbToRgb({h: 0 == a.h ? 250 : a.h, s: 100, b: 100}),
                d = 150 - a.b / 100 * 150 - 6, e = a.s / 100 * 230 - 6, a = parseInt(a.h / 360 * 160),
            ...
            var b = 0 > a.ident.top ? 0 : a.ident.top, d = 0 > a.ident.left ? 0 : a.ident.left, a = {
                s: ((230 < d ? 230 : d) + 6) / 230 * 100,
                b: 100 - ((150 < b ? 150 : b) + 6) / 150 * 100,
                h: a.hsb.h
            }, b = this.hsbToHex(a), d = this.hexToRgb(b);
            this.options.hex = b;
            this.options.hsb = a;
            ...
            c("#paigusu-palette").off().on("mousedown", function (b) {
                ...
                b = b || f.event;
                f.paigusupalette && (a.set({ident: {top: b.offsetY - 6, left: b.offsetX - 6}}), a.palette())
            }).on("mouseup", function () {
                f.paigusupalette = !1
            ...
            c("#paigusu-slider").off().on("mousedown", function (b) {
                ...
                b = b || f.event;
                f.paigususlider && (a.set({colorSlider: 0 > b.offsetX ? 0 : b.offsetX}), a.doploy())
            }).on("mouseup", function () {
                f.paigususlider = !1
            }).on("mouseleave", function () {
                f.paigususlider = !1
            ...
            c(".paigusu-lately").on("click", function () {
                var b = c(this).data("color"), d = b.split(","),
                    e = {r: parseInt(d[0]), g: parseInt(d[1]), b: parseInt(d[2])}, b = e;
                b.a = d["3"] || 1;
                d = a.rgbToHex(e);
                a.callBack(a.eve, {
                    hex: d,
            ...
            c("#paigusu-ok").on("click", function () {
                ...
                if (f.localStorage) {
                    var d = f.localStorage, e = d.getItem("paigusu-lately"), e = e.split("-");
                    e.shift();
