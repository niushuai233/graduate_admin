...
(function ($) {
    ...
    var PageGrid = {
        ...
        /**跳到分页页面 by niushuai 2017/6/22*/
        toPage: function (R,obj, $grid, url) {
            defaultParam.page = obj.curr;
            /**增加每页显示条数 by niushuai 2017/08/21*/
            defaultParam.limit = obj.limit;
            /**解决列表页两次请求后台问题 by niushuai 2018/01/02*/
            //是否是首次加载列表
