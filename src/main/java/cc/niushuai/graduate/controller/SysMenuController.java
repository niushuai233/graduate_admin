...
public class SysMenuController extends AbstractController {
    ...
    public ResultUtil menuList() {
        ...
        return ResultUtil.ok().put("page", menuList);
    }
    ...
    @RequestMapping("/save")
    @RequiresPermissions("sys:menu:save")
    public ResultUtil save(@RequestBody SysMenu menu) {
        //数据校验
        verifyForm(menu);
    ...
    private void verifyForm(SysMenu menu) {
        ...
        //菜单
        if (menu.getType() == ConstantMethod.MenuType.MENU.getValue()) {
        ...
        //上级菜单类型
        int parentType = ConstantMethod.MenuType.CATALOG.getValue();
        ...
        //目录、菜单
        if (menu.getType() == ConstantMethod.MenuType.CATALOG.getValue() ||
                menu.getType() == ConstantMethod.MenuType.MENU.getValue()) {
            if (parentType != ConstantMethod.MenuType.CATALOG.getValue()) {
        ...
        //按钮
        if (menu.getType() == ConstantMethod.MenuType.BUTTON.getValue()) {
            if (parentType != ConstantMethod.MenuType.MENU.getValue()) {
